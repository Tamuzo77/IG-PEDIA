        ...
        <div class="col-lg-8">
            <div class="card mb-3">
                ...
                <div class="card-body z-1">
                    ...
                    <p class="mb-0">
                        Créer un cours est une expérience passionnante où vous avez l'opportunité de partager vos
                        connaissances avec une communauté d'apprenants enthousiastes. Que vous soyez un expert chevronné
                        ou un novice désireux de transmettre votre passion, IG-PEDIA est là pour vous aider à donner vie
                        à votre vision éducative.
                        Imaginez un monde où les apprenants peuvent explorer des sujets variés, acquérir de nouvelles
                        compétences et élargir leurs horizons, tout cela à travers une interface conviviale et
            ...
            <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                    {{-- form 1 --}}
                    <form class="row gx-2" class="dropzone" id="my-awesome-dropzone">
                        <div class="col-12 mb-3">
                            <label class="form-label" for="course-name">Course Title<span
                                    class="text-danger">*</span></label>
                            <input class="form-control" id="course-name" type="text" placeholder="Course Title"
                                required="required" />
                        </div>
                        ...
                        <div class="mb-3"><label class="form-label" for="course-tags">Tags<span
                                ...
                                id="course-tags" multiple="multiple" size="1" name="tags[]" required="required"
            ...
            <div class="card mb-3">
                                ...
                                <tr class="btn-reveal-trigger bg-light">
                                    <td class="align-middle white-space-nowrap">
                                        <div class="d-flex gap-3 align-items-center position-relative"><img
                                                ...
                                                width="60" alt="" />
                                            <div>
                                                <h5 class="fs-0 text-primary">Intro<span data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="Requirement fulfilled"><span
                ...
                <div class="card-footer py-2 text-center">
                  <button class="btn btn-link btn-sm px-0 fw-medium" type="button" data-bs-toggle="modal" data-bs-target="#error-modal"><span class="fas fa-plus me-1 fs--2"></span>Add New Chapter</button>
                </div>
            </div>
            <div class="card mb-3">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <div class="d-flex hover-actions-trigger align-items-center py-3"><span
                                ...
                                <p class="mb-0 fs--1 me-6">This course requires profieciency in English language as the
                                    Lessons are prepared in English.</p>
                                <div class="hover-actions end-0 top-50 translate-middle-y"><button
                                        class="btn btn-link me-3 fs--2 p-0 text-700" data-bs-toggle="tooltip"
                        ...
                        <li>
                            <div class="d-flex hover-actions-trigger align-items-center py-3 border-top border-300">
                                ...
                                <p class="mb-0 fs--1 me-6">Learners with following skills might be more benefited, but
            ...
            <div class="card mb-3 mb-lg-0">
                ...
                <div class="card-body"> <label class="mb-3 form-label lh-1" for="course-goal">Course Goals <span
                    ...
                    <ul class="list-unstyled mb-0">
                        <li>
                            <div class="d-flex py-3 hover-actions-trigger align-items-center border-top border-300">
                                <span class="fas fa-grip-lines fs--2 text-secondary me-3"></span>
                ...
                <div class="card mb-lg-3 order-lg-0 order-1">
                    <div class="card-header py-2 d-flex flex-between-center">
                        <h5 class="mb-0">Publish your Course</h5><a class="btn btn-link btn-sm text-secondary px-0"
                            href="#!"><span class="fw-medium d-lg-none d-xxl-inline-block">Preview</span><span
                                class="fas fa-external-link-alt fs--2 ms-2"></span></a>
                    </div>
                    <div class="card-body bg-light">
                        <ul class="list-unstyled fs--1 mb-0">
                            <li class="mb-2 hover-actions-trigger"><span class="fas fa-file me-2"></span><span
                                    class="ms-1">Condition: </span><span
                            ...
                            <li class="mb-2 hover-actions-trigger"><span class="fas fa-unlock-alt me-2"></span><span
                                    class="ms-1">Privacy: </span><span
                                    class="text-800 fw-medium me-2">Public</span><a
                                    class="btn btn-link btn-sm p-0 lh-sm hover-actions" href="#!">Edit</a></li>
                            <li class="mb-2 hover-actions-trigger"><span class="fas fa-globe me-2"></span><span
                                    class="ms-1">Visibility: </span><span class="text-800 fw-medium me-2">Global
                            ...
                            <li class="hover-actions-trigger"><span class="fas fa-clock me-2"></span><span
                                    class="ms-1">Publish: </span><span class="text-800 fw-medium me-2">Now</span><a
                                    class="btn btn-link btn-sm p-0 lh-sm hover-actions" href="#!">Edit</a></li>
                        </ul>
                    </div>
                  ...
                  <div class="card-body bg-light">
                      <form class="dropzone dropzone-single p-0" data-dropzone="data-dropzone"
                          ...
                          <div class="dz-message fs--1" data-dz-message="data-dz-message"><img
                                  class="me-2" src="admin/assets/img/icons/cloud-upload.svg"
                                  width="20" alt="" /><span
                                  class="d-none d-lg-inline">Drag your .mp4 or .mkv file here<br />or,
                ...
                <div class="card mb-3 mb-lg-0">
                    ...
                    <div class="card-body bg-light">
                        <div class="row gx-2">
                            ...
                            <div class="col-12"><label class="form-label" for="discounted-price">Discounted Price
                                    <span data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Course discounted price"><span
                                            class="fas fa-question-circle text-primary fs--1 ms-1"></span></span></label><input
                                    class="form-control" id="discounted-price" type="text" placeholder="" />
                            </div>
