    ...
    <div class="card-header">
        <div class="row flex-between-end">
            <div class="col-auto align-self-center">
                <h5 class="mb-0" data-anchor="data-anchor" id="custom-styles-example"> {{ __("Tag: $tag->name Edit") }}
        ...
        <div class="tab-content">
            <div class="tab-pane preview-tab-pane active show" role="tabpanel"
                ...
                <form class="row g-3 needs-validation was-validated" novalidate=""
                    action="{{ route('admin.tag-update', \Illuminate\Support\Facades\Crypt::encrypt($tag->id)) }}" method="POST">
                    @csrf
                    @method('PATCH')
                    <x-admin.form.input name="Tag Name" value="{{ $tag->name }}" placeholder="Laravel" />
                    ...
                    <div class="col-12">
                        <div class="form-check"><input class="form-check-input" id="invalidCheck" type="checkbox"
                                ...
                                for="invalidCheck">Agree to terms and conditions of updating</label>
