<x-admin.layouts>
        ...
        <div class="row g-lg-3 font-sans-serif">
          <div class="col-lg-8">
            <div class="card mb-3">
              <div class="bg-holder d-none d-lg-block bg-card" style="background-image:url({{ asset('admin/assets/img/icons/spot-illustrations/corner-4.png') }});"></div>
              <!--/.bg-holder-->
              <div class="card-body z-1">
                <h3>Créer un Nouveau Cours</h3>
                <p class="mb-0">
                    Créer un cours est une expérience passionnante où vous avez l'opportunité de partager vos connaissances avec une communauté d'apprenants enthousiastes. Que vous soyez un expert chevronné ou un novice désireux de transmettre votre passion, IG-PEDIA est là pour vous aider à donner vie à votre vision éducative.
                    Imaginez un monde où les apprenants peuvent explorer des sujets variés, acquérir de nouvelles compétences et élargir leurs horizons, tout cela à travers une interface conviviale et intuitive. C'est exactement ce que nous vous proposons avec IG-PEDIA.</p>
              </div>
            </div>
            <div class="card mb-3">
...
--}}                  
                    <div class="mb-3"><label class="form-label" for="course-tags">Tags<span class="text-danger">*</span></label><select class="form-select js-choice" id="course-tags" multiple="multiple" size="1" name="tags[]" required="required" data-placeholder="Select upto 4 tags" data-options='{"removeItemButton":true,"placeholder":true}'>
                    ...
                    <tbody>
                      <tr class="btn-reveal-trigger bg-light">
                        <td class="align-middle white-space-nowrap">
                          <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('admin/assets/img/elearning/lessons/intro.png') }}" width="60" alt="" />
                            <div>
                      ...
                      <tr class="btn-reveal-trigger">
                        <td class="align-middle white-space-nowrap">
                          <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('admin/assets/img/elearning/lessons/chapter1.png') }}" width="60" alt="" />
                            <div>
                      ...
                      <tr class="btn-reveal-trigger bg-light">
                        <td class="align-middle white-space-nowrap">
                          <div class="d-flex gap-3 align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('admin/assets/img/elearning/lessons/chapter2.png') }}" width="60" alt="" />
                            <div>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                  <form class="dropzone dropzone-single p-0" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"acceptedFiles":"image/*"}'>
                    ...
                    <div class="dz-message fs--1" data-dz-message="data-dz-message"><img class="me-2" src="{{ asset('admin/assets/img/icons/cloud-upload.svg') }}" width="20" alt="" /><span class="d-none d-lg-inline">Drag your image here<br/>or, </span><span class="btn btn-link p-0 fs--1">Browse</span></div>
                  </form>
                </div>
              </div>
              <div class="card mb-3">
                ...
                <div class="card-body bg-light">
                  <form class="dropzone dropzone-single p-0" data-dropzone="data-dropzone" data-options='{"maxFiles":1,"acceptedFiles":".mp4,.mkv,.avi"}'>
                    ...
                    <div class="dz-message fs--1" data-dz-message="data-dz-message"><img class="me-2" src="{{ asset('admin/assets/img/icons/cloud-upload.svg') }}" width="20" alt="" /><span class="d-none d-lg-inline">Drag your .mp4 or .mkv file here<br/>or, </span><span class="btn btn-link p-0 fs--1">Browse</span></div>
